...
function Form({data,tierId}: Props) {
    ...
    const grandotal = (currentTier?.price ||0 ) + tax;
        ...
        <div className="flex flex-col gap-y-7 px-4">
          ...
          >
            ...
            >
              ...
              >
                <Image src={ArrowCircleDown} alt="arrow-circle-down" />
              </span>
            </label>
            <div
              ...
              <div className="flex relative">
                ...
                >
                  <span className="text-sm text-gray2">Paket Catering</span>
                                     <span className="font-semibold">Rp {Number(currentTier?.price || 0).thousands()}</span>
                </div>
              </div>
              ...
              <div className="flex relative">
                ...
                >
                  <span className="text-sm text-gray2">PPN 11%</span>
                                     <span className="font-semibold">Rp {Number(tax || 0).thousands()}</span>
                </div>
              </div>
            </div>
          </div>
            ...
            >
              <span className="flex flex-col">
                <span className="text-gray2 text-sm">Grand Total</span>
                                 <span className="font-semibold text-xl">Rp {Number(grandotal || 0).thousands()}</span>
              </span>
              <button
                type="submit"
